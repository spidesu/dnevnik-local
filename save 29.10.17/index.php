...
function generate_avatar(){
	...
	$letters = substr($_SESSION['name'], 0, 2);
	$avatar_example = file_get_contents('images/avatars/avatar.svg');
	...
	file_put_contents('images/avatars/'.$gen_avatar, $avatar_example);
	return($gen_avatar);
}
...
?>
<?
echo 'images/avatars/'.generate_avatar();
?>
<!DOCTYPE html>
<html lang="en">
	<head>
